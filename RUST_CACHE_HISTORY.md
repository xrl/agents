...
**Historical evidence, not operating instructions.** Snapshot retained from
2026-09-19, including earlier experiments and superseded rollout proposals.
Commands, caps, versions, and proposed gates below describe those dates; do not
execute them merely because they appear here. Current operation belongs to
[RUST_AGENT_RULES.md](RUST_AGENT_RULES.md); verification work starts with
[RUST_CACHE_VALIDATION.md](RUST_CACHE_VALIDATION.md). kache is standard.
...
## Additional law receipts (historical)

These are the former workstation-law receipts, not current configuration.
...
### Law 22: retired sccache behavior
